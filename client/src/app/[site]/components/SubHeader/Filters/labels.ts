...
export function getParameterLabel(parameter: FilterParameter, t: T): string {
  switch (parameter) {
...
export function getOperatorLabel(type: FilterType, isNumeric: boolean, t: T): string {
  switch (type) {
...
export function getOperatorMenuLabel(type: FilterType, isNumeric: boolean, t: T): string {
  switch (type) {
    case "equals": return isNumeric ? t("Equals") : t("Is");
    case "not_equals": return isNumeric ? t("Not equals") : t("Is not");
    case "contains": return t("Contains");
