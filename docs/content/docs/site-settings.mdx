...
- **Dashboard Embed** shows the public analytics dashboard in an iframe. Configure it from the **Dashboard Embed** tab. This requires Public Analytics. See the [Dashboard Embed guide](/docs/embeds/dashboard) for details.
